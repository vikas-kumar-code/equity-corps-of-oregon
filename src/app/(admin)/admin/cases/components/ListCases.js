...
export default function ListCases() {
    ...
    return (
        <div>
            <Row>
                <Col md={6} sm={12}><h3>Cases</h3></Col>
                <Col md={6} sm={12} className='text-end'>
                    ...
                    <Button variant='primary' type='button' onClick={() => getUser()}>Add New Case</Button>
                </Col>
            </Row>
            <SearchBox
                open={showSearchBox}
                            ...
                            <Card.Body>
                                ...
                                <div className="table-responsive">
                                    <table className="table">
                                        ...
                                        <tbody>
                                            {records.map((record, index) => <tr key={`cases-key-${index}`}>
