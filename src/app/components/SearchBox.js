...
import { Button, Card, Collapse, FloatingLabel, Form, Row, Col, Spinner } from 'react-bootstrap'
    ...
    <Collapse in={props.open}>
      <Form onSubmit={handleSubmit}>
        <Card className='mb-3'>
          ...
          <Card.Footer>
            <Button variant='danger' className='me-2' size='lg' onClick={() => {
              setFields({})
            }}>Clear</Button>
            <Button variant='success' size='lg' disabled={submitted} type='submit'>{submitted && <Spinner size='sm' className='me-1' />}Search</Button>
          </Card.Footer>
        </Card>
      </Form>
    </Collapse>
